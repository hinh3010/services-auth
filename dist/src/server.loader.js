...
const serverLoader = (context) => {
    return (app) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        // session
        const sessionSecret = yield (0, config_1.getGlobalSetting)(context)('session_secret');
        app.use((0, express_session_1.default)({
            secret: sessionSecret !== null && sessionSecret !== void 0 ? sessionSecret : 'hellocacbantre',
            resave: false,
