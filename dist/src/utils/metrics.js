...
function startMetricsServer(app, port) {
    (0, prom_client_1.collectDefaultMetrics)();
    // eslint-disable-next-line @typescript-eslint/no-misused-promises
    app.get('/metrics', (_, res) => __awaiter(this, void 0, void 0, function* () {
        res.set('Content-Type', prom_client_1.register.contentType);
        return res.send(yield prom_client_1.register.metrics());
    }));
    _loggers_1.default.info(`[Metrics_Start:::] http://localhost:${port}/metrics`);
}
